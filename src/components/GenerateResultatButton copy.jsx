...
//     if (test.exceptions.reticulocytes.pourcentage?.valeur) {
//       doc.text(`Pourcentage : ${test.exceptions.reticulocytes.pourcentage.valeur} ${test.exceptions.reticulocytes.pourcentage.unite}`, 25, excepY)
//       excepY += 5
//     }

//     if (test.exceptions.reticulocytes.gbRouges?.valeur) {
//       doc.text(`Globules rouges : ${test.exceptions.reticulocytes.gbRouges.valeur} ${test.exceptions.reticulocytes.gbRouges.unite}`, 25, excepY)
//       excepY += 5
//     }
...
//       doc.setFont('Times', 'bold')
//       doc.text(`Pourcentage calculé : ${test.exceptions.reticulocytes.pourcentageCalcule.valeur} ${test.exceptions.reticulocytes.pourcentageCalcule.unite}`, 25, excepY)
//       doc.setFont('Times', 'normal')
//       excepY += 10
//     }
...
//     if (test.exceptions.clairanceCreatinine.age?.valeur) {
//       doc.text(`Âge : ${test.exceptions.clairanceCreatinine.age.valeur} ${test.exceptions.clairanceCreatinine.age.unite}`, 25, excepY)
//       excepY += 5
//     }

//     if (test.exceptions.clairanceCreatinine.poids?.valeur) {
//       doc.text(`Poids : ${test.exceptions.clairanceCreatinine.poids.valeur} ${test.exceptions.clairanceCreatinine.poids.unite}`, 25, excepY)
//       excepY += 5
//     }

//     if (test.exceptions.clairanceCreatinine.sexe) {
//       const sexeLabel = test.exceptions.clairanceCreatinine.sexe === 'M' ? 'Masculin' : 'Féminin'
//       doc.text(`Sexe : ${sexeLabel}`, 25, excepY)
//       excepY += 5
//     }

//     if (test.exceptions.clairanceCreatinine.creatinineMgL?.valeur) {
//       doc.text(`Créatinine : ${test.exceptions.clairanceCreatinine.creatinineMgL.valeur} ${test.exceptions.clairanceCreatinine.creatinineMgL.unite}`, 25, excepY)
//       excepY += 5
//     }
...
//     if (test.exceptions.dfg.creatinineMgL?.valeur) {
//       doc.text(`Créatinine sérique : ${test.exceptions.dfg.creatinineMgL.valeur} ${test.exceptions.dfg.creatinineMgL.unite}`, 25, excepY)
//       excepY += 5
//     }

//     if (test.exceptions.dfg.age?.valeur) {
//       doc.text(`Âge : ${test.exceptions.dfg.age.valeur} ${test.exceptions.dfg.age.unite}`, 25, excepY)
//       excepY += 5
//     }

//     if (test.exceptions.dfg.sexe) {
//       const sexeLabel = test.exceptions.dfg.sexe === 'M' ? 'Masculin' : 'Féminin'
//       doc.text(`Sexe : ${sexeLabel}`, 25, excepY)
//       excepY += 5
//     }
...
//       doc.setFont('Times', 'bold')
//       doc.text(`CTFF calculé : ${test.exceptions.saturationTransferrine.ctff.valeur} ${test.exceptions.saturationTransferrine.ctff.unite}`, 25, excepY)
//       doc.setFont('Times', 'normal')
//       excepY += 5
//     }
...
//     if (test.exceptions.compteAddis.leucocytesTotaux?.valeur) {
//       doc.text(`Leucocytes totaux : ${test.exceptions.compteAddis.leucocytesTotaux.valeur} ${test.exceptions.compteAddis.leucocytesTotaux.unite}`, 25, excepY)
//       excepY += 5
//     }

//     if (test.exceptions.compteAddis.hematiesTotales?.valeur) {
//       doc.text(`Hématies totales : ${test.exceptions.compteAddis.hematiesTotales.valeur} ${test.exceptions.compteAddis.hematiesTotales.unite}`, 25, excepY)
//       excepY += 5
//     }
...
//       doc.setFont('Times', 'bold')
//       doc.text(`Leucocytes/minute : ${test.exceptions.compteAddis.leucocytesParMinute.valeur} ${test.exceptions.compteAddis.leucocytesParMinute.unite}`, 25, excepY)
//       doc.setFont('Times', 'normal')
//       excepY += 5
//     }
...
//     if (test.exceptions.calciumCorrige.calciumMesure?.valeur) {
//       doc.text(`Calcium mesuré : ${test.exceptions.calciumCorrige.calciumMesure.valeur} ${test.exceptions.calciumCorrige.calciumMesure.unite}`, 25, excepY)
//       excepY += 5
//     }

//     if (test.exceptions.calciumCorrige.albumine?.valeur) {
//       doc.text(`Albumine : ${test.exceptions.calciumCorrige.albumine.valeur} ${test.exceptions.calciumCorrige.albumine.unite}`, 25, excepY)
//       excepY += 5
//     }
...
//   if (test.exceptions.cholesterolLdl.cholesterolTotal?.valeur) {
//     doc.text(`Cholestérol total : ${test.exceptions.cholesterolLdl.cholesterolTotal.valeur} ${test.exceptions.cholesterolLdl.cholesterolTotal.unite}`, 25, excepY)
//     excepY += 5
//   }

//   if (test.exceptions.cholesterolLdl.hdl?.valeur) {
//     doc.text(`HDL : ${test.exceptions.cholesterolLdl.hdl.valeur} ${test.exceptions.cholesterolLdl.hdl.unite}`, 25, excepY)
//     excepY += 5
//   }

//   if (test.exceptions.cholesterolLdl.triglycerides?.valeur) {
//     doc.text(`Triglycérides : ${test.exceptions.cholesterolLdl.triglycerides.valeur} ${test.exceptions.cholesterolLdl.triglycerides.unite}`, 25, excepY)
//     excepY += 5
//   }

//   if (test.exceptions.cholesterolLdl.ldl?.valeur) {
//     doc.setFont('Times', 'bold')
//     doc.text(`LDL calculé : ${test.exceptions.cholesterolLdl.ldl.valeur} ${test.exceptions.cholesterolLdl.ldl.unite}`, 25, excepY)
//     doc.setFont('Times', 'normal')
//     excepY += 5
...
//     if (test.exceptions.bilirubineIndirecte.bilirubineTotale?.valeur) {
//       doc.text(`Bilirubine totale : ${test.exceptions.bilirubineIndirecte.bilirubineTotale.valeur} ${test.exceptions.bilirubineIndirecte.bilirubineTotale.unite}`, 25, excepY)
//       excepY += 5
//     }

//     if (test.exceptions.bilirubineIndirecte.bilirubineDirecte?.valeur) {
//       doc.text(`Bilirubine directe : ${test.exceptions.bilirubineIndirecte.bilirubineDirecte.valeur} ${test.exceptions.bilirubineIndirecte.bilirubineDirecte.unite}`, 25, excepY)
//       excepY += 5
//     }

//     if (test.exceptions.bilirubineIndirecte.bilirubineIndirecte?.valeur) {
//       doc.setFont('Times', 'bold')
//       doc.text(`Bilirubine indirecte calculée : ${test.exceptions.bilirubineIndirecte.bilirubineIndirecte.valeur} ${test.exceptions.bilirubineIndirecte.bilirubineIndirecte.unite}`, 25, excepY)
//       doc.setFont('Times', 'normal')
//       excepY += 10
//     }
...
function GenerateResultatButton({ invoice }) {
  ...
  // ✅ CORRECTION : Suppression de l'interprétation dans renderDfgException
  const renderDfgException = (doc, test, excepY, invoice) => {
    excepY = checkNewPage(doc, excepY, invoice)
    doc.setFont('Times', 'normal')
    doc.setFontSize(9)
    ...
    if (test.exceptions.dfg.dfgValue?.valeur) {
      ...
      // ✅ SUPPRIMÉ : L'interprétation du tableau sera affichée par renderInterpretation()
    }
  ...
  // ✅ CORRECTION : Amélioration de renderCompteAddisException pour afficher toutes les valeurs
  const renderCompteAddisException = (doc, test, excepY, invoice) => {
    excepY = checkNewPage(doc, excepY, invoice)
    doc.setFont('Times', 'normal')
    doc.setFontSize(9)
    ...
    if (test.exceptions.compteAddis.dureeRecueil?.valeur) {
      doc.text(`Durée recueil : ${test.exceptions.compteAddis.dureeRecueil.valeur} ${test.exceptions.compteAddis.dureeRecueil.unite}`, 25, excepY)
      excepY += 7
    }
  ...
  // ✅ CORRECTION : Suppression de l'interprétation dans renderRapportAlbuminurieException
  const renderRapportAlbuminurieException = (doc, test, excepY, invoice) => {
    excepY = checkNewPage(doc, excepY, invoice)
    doc.setFont('Times', 'normal')
    doc.setFontSize(9)
    ...
    if (test.exceptions.rapportAlbuminurie.rapport?.valeur) {
      ...
      // ✅ SUPPRIMÉ : L'interprétation sera affichée par renderInterpretation()
    }
  ...
  // ✅ CORRECTION : renderInterpretation reste la SEULE fonction à afficher les interprétations
  const renderInterpretation = (doc, test, currentY, invoice) => {
    const interpretation = test.statutMachine ? test.testId.interpretationA : test.testId.interpretationB
