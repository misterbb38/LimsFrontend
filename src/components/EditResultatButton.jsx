...
//           culture: {
//             ...data.data.culture,
//             germeIdentifie: data.data.culture.germeIdentifie.map((germe) => ({
//               nom: germe.nom,
//               antibiogramme: Object.entries(germe.antibiogramme).map(
//                 ([antibiotique, sensibilite]) => ({ antibiotique, sensibilite })
//               ),
//             })),
//           },
