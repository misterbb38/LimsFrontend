...
//   // ✅ CORRECTION TOTALE : Gestion robuste de toutes les variantes de noms de propriétés
...
//     console.log('[COMPTE ADDIS] Structure complète:', addis)
    
//     // Vérifier toutes les variantes possibles de noms de propriétés
//     // Variante 1: leucocytesTotaux / Variante 2: leucocytestotaux / Variante 3: leucocyteTotal, etc.
//     const leucoTotal = addis.leucocytesTotaux || addis.leucocytestotaux || addis.leucocyteTotal || addis.leucocytes
//     const hematieTotal = addis.hematiesTotales || addis.hematiestotales || addis.hematieTotal || addis.hematies
//     const duree = addis.dureeRecueil || addis.dureerecueil || addis.duree || addis.dureeMinutes
//     const leucoMin = addis.leucocytesParMinute || addis.leucocytesparminute || addis.leucocyteMinute
//     const hematieMin = addis.hematiesParMinute || addis.hematiesparminute || addis.hematieMinute

//     let hasAnyValue = false

//     // Leucocytes totaux
//     if (leucoTotal?.valeur) {
//       hasAnyValue = true
//       doc.text(`Leucocytes totaux : ${leucoTotal.valeur} ${leucoTotal.unite || ''}`, 25, excepY)
//       excepY += 5
//     }

//     // Hématies totales
//     if (hematieTotal?.valeur) {
//       hasAnyValue = true
//       doc.text(`Hématies totales : ${hematieTotal.valeur} ${hematieTotal.unite || ''}`, 25, excepY)
//       excepY += 5
//     }
...
//     if (duree?.valeur) {
//       hasAnyValue = true
//       doc.text(`Durée recueil : ${duree.valeur} ${duree.unite || 'minutes'}`, 25, excepY)
//       excepY += 7
//     }

//     // Leucocytes par minute (calculé)
//     if (leucoMin?.valeur) {
//       hasAnyValue = true
//       doc.setFont('Times', 'bold')
//       doc.text(`Leucocytes/min : ${leucoMin.valeur} ${leucoMin.unite || 'éléments/min'}`, 25, excepY)
//       doc.setFont('Times', 'normal')
//       excepY += 5
//     }

//     // Hématies par minute (calculé)
//     if (hematieMin?.valeur) {
//       hasAnyValue = true
//       doc.setFont('Times', 'bold')
//       doc.text(`Hématies/min : ${hematieMin.valeur} ${hematieMin.unite || 'éléments/min'}`, 25, excepY)
//       doc.setFont('Times', 'normal')
//       excepY += 10
//     }

//     // // Si aucune valeur trouvée, afficher un message de debug
//     // if (!hasAnyValue) {
//     //   console.warn('[COMPTE ADDIS] Aucune valeur trouvée. Structure reçue:', JSON.stringify(addis, null, 2))
//     //   doc.setFont('Times', 'italic')
//     //   doc.setFontSize(8)
//     //   // doc.text('(Données en attente de saisie)', 25, excepY)
//     //   excepY += 10
//     // }
...
//       doc.setFont('Times', 'bold')
//       doc.text(`Rapport : ${test.exceptions.rapportAlbuminurie.rapport.valeur} ${test.exceptions.rapportAlbuminurie.rapport.unite}`, 25, excepY)
//       doc.setFont('Times', 'normal')
//       excepY += 7
//     }
