import { c as Ke, _ as Ua, g as wo } from './index-T8Qzqm_Y.js'
var vt = function (a) {
...
var bi = function (a, e) {
  ...
  hr
pn &&
  ((ue = pn.split('.')), (hr = ue[0] > 0 && ue[0] < 4 ? 1 : +(ue[0] + ue[1])))
!hr &&
  Kr &&
  ((ue = Kr.match(/Edge\/(\d+)/)),
  (!ue || ue[1] >= 74) &&
    ((ue = Kr.match(/Chrome\/(\d+)/)), ue && (hr = +ue[1])))
var xi = hr,
  yn = xi,
  Dl = L,
  Ll = D,
...
var Si = ko.exports,
  ...
  z = function (a) {
    return (
      On(ta, a) || (ta[a] = dh && On(Ze, a) ? Ze[a] : yh('Symbol.' + a)), ta[a]
    )
  },
  mh = Y,
  Tn = de,
  ...
  Eh = function (a, e) {
    ...
    var t = bh(a, Sh),
      r
    if (t) {
      if ((e === void 0 && (e = 'default'), (r = mh(t, a, e)), !Tn(r) || Sn(r)))
        return r
...
var Sr = { set: vr, get: Ot, has: fr, enforce: yv, getterFor: mv },
  ...
  Rv = (Go.exports = function (a, e, t) {
    $v(Rn(e), 0, 7) === 'Symbol(' &&
      ...
      t && t.getter && (e = 'get ' + e),
      t && t.setter && (e = 'set ' + e),
      (!Gt(a, 'name') || (Ov && a.name !== e)) &&
        (Wa ? ir(a, 'name', { value: e, configurable: !0 }) : (a.name = e)),
      Av &&
        t &&
        Gt(t, 'arity') &&
        a.length !== t.arity &&
        ir(a, 'length', { value: t.arity })
    try {
      t && Gt(t, 'constructor') && t.constructor
        ? Wa && ir(a, 'prototype', { writable: !1 })
        : a.prototype && (a.prototype = void 0)
    } catch {}
    var r = Sv(a)
    return (
      Gt(r, 'source') || (r.source = Cv(Pv, typeof e == 'string' ? e : '')), a
    )
  })
...
var rf = je,
  ...
  $r = function (a, e, t) {
    a && !t && (a = a.prototype),
      a && !Uf(a, _n) && jf(a, _n, { configurable: !0, value: e })
  },
  Vn = Xo,
  zf = Te,
  Hf = function (a, e, t) {
    return (
      t.get && Vn(t.get, e, { getter: !0 }),
      t.set && Vn(t.set, e, { setter: !0 }),
      zf.f(a, e, t)
    )
  },
  Yf = je,
  ...
  zc
    ...
    : la && la.now
      ...
      : zn && !Gc
        ? ((va = new zn()),
          (fa = va.port2),
          (va.port1.onmessage = Yn),
          (Ie = Bc(fa.postMessage, fa)))
        : ae.addEventListener &&
            jn(ae.postMessage) &&
            !ae.importScripts &&
            Tt &&
  ...
  xg = gg('Promise', function () {
    ...
    if (!ma || ma < 51 || !/native code/.test(a)) {
      var t = new xt(function (n) {
        ...
        i = (t.constructor = {})
      if (((i[bg] = r), (Za = t.then(function () {}) instanceof r), !Za))
        return !0
    }
    return !e && (yg || mg) && !du
  }),
...
var Sg = ee,
  ...
  Cu = function (a, e, t) {
    ...
    Lg
      ...
      !Mg && (i = we['on' + a])
        ? i(r)
        : a === Ou && Rg('Unhandled promise rejection', t)
  },
  jg = function (a) {
    nt(pu, we, function () {
      var e = a.facade,
  ...
  tt = function (a, e, t) {
    a.done ||
      ((a.done = !0), t && (a = t), (a.value = e), (a.state = Bg), wu(a, !0))
  },
  ti = function (a, e, t) {
    if (!a.done) {
      ;(a.done = !0), t && (a = t)
...
var dp = K,
  ...
  ur = function () {
    ...
    ur =
      typeof document < 'u' ? (document.domain && Kt ? bs(Kt) : Op()) : bs(Kt)
...
var Gi =
    ...
    function (e, t) {
      ...
      return (
        e !== null
          ? ((xa[ai] = dp(e)), (r = new xa()), (xa[ai] = null), (r[Du] = e))
          : (r = ur()),
        t === void 0 ? r : pp.f(r, t)
      )
    },
...
`) &&
  ...
  si = (function () {
    var a = /a/,
      e = /b*/g
    return (
      et(dr, a, 'a'), et(dr, e, 'a'), a.lastIndex !== 0 || e.lastIndex !== 0
    )
  })(),
  ku = Ip.BROKEN_CARET,
  oi = /()??/.exec('')[1] !== void 0,
    ...
    if (!n || !o || t) {
      var s = /./[i],
        u = e(i, ''[a], function (l, h, f, c, v) {
          var d = h.exec
          return d === zp || d === Ta.exec
            ? n && !v
              ? { done: !0, value: Os(s, h, f, c) }
              : { done: !0, value: Os(l, f, h, c) }
            : { done: !1 }
        })
...
;[].keys &&
  ((Aa = [].keys()),
  'next' in Aa
    ? ((Ca = _s(_s(Aa))), Ca !== Object.prototype && (Le = Ca))
    : (Uu = !0))
var Om =
  !mm(Le) ||
  pm(function () {
  ...
  Fm = function (a, e, t, r, i, n, o) {
    ...
    if (
      (v &&
        ...
        d !== Object.prototype &&
          d.next &&
          (Vs(d) !== Ls && (Ds ? Ds(d, Ls) : Nm(d[ct]) || Pa(d, ct, Bm)),
          Mm(d, u, !0))),
      Lm &&
        i === gt &&
        f &&
      ...
      if (((g = { values: s(gt), keys: n ? c : s(ks), entries: s(Bs) }), o))
        for (p in g) (Zt || l || !(p in h)) && Pa(h, p, g[p])
    ...
    return function (e, t, r, i) {
      ...
      if (r < 2)
        for (;;) {
          ...
          if (((u += l), a ? u < 0 : s <= u))
            throw new o0('Reduce of empty array with no initial value')
        }
    ...
    return [
      ...
      function (i, n) {
        ...
        for (var d = 0, g = 0, p = []; g < s.length; ) {
          ...
          if (
            y === null ||
            (x = L0(I0(c.lastIndex + (qe ? g : 0)), s.length)) === d
          )
            g = N0(s, g, h)
          else {
...
for (var dt = 0; !st && dt < er.length; dt++)
  (st = be[er[dt] + 'Request' + rt]),
    (St = be[er[dt] + 'Cancel' + rt] || be[er[dt] + 'CancelRequest' + rt])
if (!st || !St) {
  var La = 0,
    Ks = 0,
    Me = [],
  ...
  function n(s, u, l, h, f, c) {
    return (
      ...
      i(function (v, d, g, p) {
        ...
        return (
          v.sweepFlag !== void 0 && 0 > T && (v.sweepFlag = +!v.sweepFlag), v
        )
      })
    )
  }
      ...
      return i(function (c, v, d, g, p) {
        ...
        if (
          (c.type & m.SMOOTH_CURVE_TO &&
            ((b = isNaN(u) ? 0 : v - u), (O = isNaN(l) ? 0 : d - l)),
      ...
      var s = function (c) {
        ...
        f = i(function (c, v, d) {
          ...
          if (
            ...
            p(g.x), y(g.y)
            for (var x = 0, b = so(v, g.x1, g.x2, g.x); x < b.length; x++)
              0 < (R = b[x]) && 1 > R && p(oo(v, g.x1, g.x2, g.x, R))
            for (var O = 0, $ = so(d, g.y1, g.y2, g.y); O < $.length; O++)
              0 < (R = $[O]) && 1 > R && y(oo(d, g.y1, g.y2, g.y, R))
          }
          if (g.type & m.ARC) {
...
`
  ...
  Cb = function (a) {
    var e = a.flags
    return e === void 0 && !('flags' in lo) && !Eb(a, 'flags') && $b(lo, a)
      ? Sb(wb, a)
      : e
  },
  Ab = Tr.PROPER,
...
function Fb(a, e, t, r, i, n) {
  ...
  v.next = c
  for (
    var p = null, y = null, x = 0, b = 0, O = Db[n], $ = Lb[n], E = 0;
    E < i;
    E++
  ) {
    v = c
    for (
      var T = o[b], C = o[b + 1], I = o[b + 2], _ = o[b + 3], F = 0;
      F < h;
      F++
    )
...
class Ir {
  ...
  stop() {
    this.intervalId && (ka.cancel(this.intervalId), (this.intervalId = null)),
      this.mouse.stop()
  }
  shouldUpdate(e, t) {
    if (!e) {
...
class O1 extends A {
  ...
  path(e) {
    ...
    return (
      e && (e.beginPath(), e.moveTo(t, r), e.lineTo(i, n)), new ve(t, r, i, n)
    )
  }
  getMarkers() {
  ...
  renderChildren(e) {
    if (this.hasText) {
      ...
      n.isWorking() &&
        n.checkBoundingBox(
          this,
          new ve(r, i - o.getPixels('y'), r + this.measureText(e), i)
        )
  ...
  findSegmentToFitChar(e, t, r, i, n, o, s, u, l) {
    ...
    if (s) {
      var y = Math.cos(Math.PI / 2 + p) * s,
        x = Math.cos(-p) * s
      ;(g.p0 = tr(tr({}, v), {}, { x: v.x + y, y: v.y + x })),
        (g.p1 = tr(tr({}, d), {}, { x: d.x + y, y: d.y + x }))
    }
